...
public class Bank {
	...
	public static void main(String[] args) {
		// create new instance of a Bank class
	...
	public void run() {
		...
		// get the next token (word), which is the customer name
		...
		// from checking
		System.out.println(); // blank line
		System.out.println("Amount (decimal) to withdra from your checking account");
		...
		// from savings
		System.out.println(); // blank line
		System.out.println("Amount (decimal) to withdra from your savings account");

		amount = scanner.nextDouble(); // get next token (double)

		try {
			checkingAccount.withdraw(amount); // withdraw from savings
		} catch (Exception e) {
			// e.printStackTrace();
			// prints custom error message from withdraw method
			System.out.println(e.getMessage());
